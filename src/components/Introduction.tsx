...
export const Introdcution = () => {
  ...
  return (
    <div className="flex absolute text-xl z-[999] font-semibold justify-center items-center rounded-3xl flex-col bg-gray-200 text-black top-2/4 left-2/4 translate-x-[-50%] translate-y-[-50%] w-[450px] h-[400px] p-7 text-center gap-6 font-serif blur-0">
      ...
      <button
        className="pt-2 pb-2 pl-6 pr-6 font-bold bg-blue-300 rounded-md hover:bg-blue-500"
        onClick={handleClick}
      >
        Start
      </button>
